...
using Jellyfin.Plugin.LocalRecs.Logging;
using Jellyfin.Plugin.LocalRecs.Output;
...
namespace Jellyfin.Plugin.LocalRecs.Tasks;
...
public sealed class RecsScheduledTask : IScheduledTask
{
    ...
    /// </summary>
    public string Key => "Jellyfin.Plugin.LocalRecs.RecsScheduledTask";
    /// <summary>
    ...
    public async Task ExecuteAsync(IProgress<double> progress, CancellationToken cancellationToken)
    {
        ...
        foreach (var user in users)
        {
            ...
            if (_config.CreateTopPicksRow)
            {
                ...
                var userRef = new Jellyfin.Plugin.LocalRecs.Abstractions.UserRef { Id = user.Id, Name = user.Username };
